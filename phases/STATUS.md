...
| 09 | [Conformance fixtures](09-conformance.md) | done | WPT urltestdata via EmberJson 0.3.4 + Unicode 17.0.0 IDNATestV2; setters/origin/JS-only WPT and transitional IDNA not run |
